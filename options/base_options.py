...
class BaseOptions():
    def initialize(self, parser):
        ...
        parser.add_argument('--train_path', type=str, default='/home/cvblgita/tri/Datasets/knowledge_distillation/train_20K_cartoon_20k_face', help='train images are saved in here')
        parser.add_argument('--test_path', type=str, default='/home/cvblgita/tri/Datasets/Cartoon/test', help='test images are saved in here')
